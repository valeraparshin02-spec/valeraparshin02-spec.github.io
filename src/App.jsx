      ...
      <main id="main">
        <section className="hero" id="top">
          ...
          <div className="hero-aside" data-reveal>
            <p>Сначала нахожу, на каком шаге потенциальный клиент не доходит до заявки: в оффере, структуре или пути на сайте. Потом собираю сайт и запуск, которые убирают эти потери.</p>
